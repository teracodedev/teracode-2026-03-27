...
export async function PUT(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const data: Record<string, unknown> = {
        ...
        kubun: kubun || null,
        isSodai: isSodai ?? false,
        tantosodai: tantosodai || null,
        yago: yago || null,
        chiku: chiku || null,
        motochiku: motochiku || null,
        chikuJunjo: chikuJunjo != null ? Number(chikuJunjo) : null,
        omairiJunjo: omairiJunjo != null ? Number(omairiJunjo) : null,
        annaiYohi: annaiYohi || null,
        nenkaiannaIYohi: nenkaiannaIYohi || null,
        tsukikiYohi: tsukikiYohi || null,
        noteNoPrint: noteNoPrint ?? false,
        preDharmaName: preDharmaName || null,
        preDharmaNameKana: preDharmaNameKana || null,
        ...
        classification4: classification4 || null,
        classification5: classification5 || null,
        classification6: classification6 || null,
        classification7: classification7 || null,
        classification8: classification8 || null,
      };
